      ...
      <div className="mb-4 grid gap-4">
        {PROJECTS.map((project) => {
          ...
          return (
            <article
              key={project.id}
              className="group min-w-0 rounded-lg border border-slate-200 bg-slate-50 p-4 transition-[border-color,box-shadow] duration-200 hover:border-slate-300 hover:shadow-sm dark:border-neutral-800 dark:bg-black dark:hover:border-neutral-700 sm:p-5"
            >
